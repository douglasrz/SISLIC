    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="funcioanrioPedidosController.jsp?acao=pedidosaberto">SISLIC - Sistema de Compras e Licita��es</a>
            </div>            
            ...
            <div class="row">
                <% for(Lance l: lances){
                    ...
                    <div class="panel panel-default">
                        ...
                        <a type="submit" href="funcionarioLancesController.jsp?acao=lance&id=<%=l.getId()%>" class="btn btn-success btn-block"> Detalhes </a> </div>
                		</div>
                		</div>
                	<%} %>
                    </div>
