...
<body>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <li class="dropdown">
					...
					out.print("<a href=cadastrocontroller.forn >"+forn.getrSocial()+"</a>");%>
                        ...
                        <a href="#"><i class="fa fa-shopping-cart fa-fw"></i> Pedidos<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                            	...
                            	for(Categoria c: categorias){
                            		out.print("<li>");
                            		out.print("<a>"+c.getNome()+"</a>");
                            		out.print("</li>");
                            	}
                            	%>
                               <li>
                                	<a href="pedidocontroller.do">Todos</a>
                               </li>
                            </ul>
                        </li>
                        <li>
                            <a href="index.jsp"><i class="fa fa-wrench fa-fw"></i>Lances<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <%
                                for(Categoria ca: categorias){
                                	out.print("<li>");
                                	out.print("<a>"+ca.getNome()+"</a>");
                                	out.print("</li>");
                                }
                                %>
                                <li>
                                	<a href="lancescontroller.do">Todos</a>
                                </li>                                
                            </ul>
                        </li>
                        <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                            	<form role="form" name="formulario" onsubmit="return validarSenha(this);" action="cadastrocontroller.do?acao=alterar" method="post">                            		
                                	<div class="col-lg-6">                                    
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
	                                <% for(Categoria cat: categorias){
								 		...
								 		//out.print("<td><a href=javascript:exclusao("+c.getCod()+")>Excluir</a></td>");
	...
	function validarSenha(form){ 
		...
		senhaRepetida = document.formulario.novasenhaAlt.value
