...
<!-- DataTables CSS -->
<link href="sbAdmin/vendor/datatables-plugins/dataTables.bootstrap.css"
	rel="stylesheet">

<!-- DataTables Responsive CSS -->
<link
	href="sbAdmin/vendor/datatables-responsive/dataTables.responsive.css"
	rel="stylesheet">
...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="pedidocontroller.do">SISLIC -
				Sistema de Compras e Licitações</a>
		</div>
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li><a href="logincontroller.do"><i
					class="fa fa-sign-out fa-fw"></i> Sair</a></li>
		</ul>
		<!-- /.navbar-top-links --> <!-- OPÇÕES DA PARTE ESQUERDA -->
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					<li><a href="funcionarioController.jsp"><i
							class="fa fa-shopping-cart fa-fw"></i>Pedidos<span
							class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="funcionarioController.jsp">Pedidos em
									aberto</a></li>
							<li><a href="#">Pedidos solicitados</a></li>
							<li><a href="#">Solicitar pedido</a></li>
						</ul></li>
					<a href="pontcontroller.do"><i class="fa fa-bar-chart-o fa-fw"></i>Fornecedores</a>
					</li>
					<li><a href=""> <i class="fa fa-legal fa-fw"></i>Lances
					</a></li>
					<li><a href="cadastrocontroller.do"><i
							class="fa fa-user fa-fw"></i>Cadastro</a></li>
					<li><a href="sobrecontroller.do"><i
							class="fa fa-info-circle fa-fw"></i> Sobre</a></li>
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
		</div>
		...
		<div id="page-wrapper">
			...
			<div class="row invoice-info">
				...
				<div class="col-sm-6 invoice-col">
					<address>
						<strong>Informações gerais</strong><br> Lançado em
						<%=pedido.getDataLancamento() %><br> Expira em
			...
			<!-- /.row -->
			<div class="row">
				<a type="submit" href="funcionarioController.jsp" class="btn btn-success pull-right btn-block"> voltar </a> 
	...
	<script
		src="sbAdmin/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
	<script
		src="sbAdmin/vendor/datatables-responsive/dataTables.responsive.js"></script>
